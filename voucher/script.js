...
botao.onclick = async () => {
    ...
    try {
        ...
        if (!duracao || duracao <= 0) {
            ...
            mensagem.innerHTML = "Voucher sem duração válida.";
            botao.disabled = false;
            return;
        ...
        if (dados.fim) {
            ...
            const fimExistente = dados.fim.toDate();

            if (agora > fimExistente) {
        ...
        /*
         * Envia a duração para o OpenNDS.
         *
         * O parâmetro "custom" será recebido pelo
         * BinAuth do OpenNDS.
         */
        ...
        if (fas) {
            ...
            inputCustom.value = "duracao=" + duracao;
